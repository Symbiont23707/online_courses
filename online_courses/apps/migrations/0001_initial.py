# Generated by Django 3.2.16 on 2023-08-25 07:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2023, 8, 25, 11, 8, 19, 359370, tzinfo=utc))),
                ('duration', models.IntegerField()),
                ('lecture', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='apps.lecture')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='uuid')),
                ('expiry_date', models.DateTimeField(default=datetime.datetime(2023, 8, 25, 11, 8, 19, 407827, tzinfo=utc))),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
